// ==UserScript==
// @name         МЭШ Автозаполнение Soft Skills PRO
...
(function () {
    ...
    async function fetchMyGroups() {
        // Сначала пробуем через расписание — фильтруется по teacher_id
        if (authState.profileId) {
            try {
                const sched = await apiFetch(`/api/ej/plan/teacher/v1/schedule_items?academic_year_id=13&teacher_id=${authState.profileId}&from=2025-09-01&to=2026-05-31&with_group_class_subject_info=true&page=1&per_page=2000`);
